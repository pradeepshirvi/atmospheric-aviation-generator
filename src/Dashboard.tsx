...
import { Download, Cloud, Plane, Activity, Settings, Database, CheckCircle, AlertCircle } from 'lucide-react';
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
              ...
              {activeTab === 'radiosonde' ? (
                ...
                <>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm text-blue-200 block mb-1">Duration (minutes)</label>
                      <input
                        type="number"
              ...
              {generatedData && (
                <div className="flex gap-2 mt-4">
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-all flex items-center justify-center gap-2"
                  >
                    <Download size={16} />
                    CSV
                  </button>
