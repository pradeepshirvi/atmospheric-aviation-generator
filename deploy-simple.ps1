...
Write-Host "   🎨 Frontend (React Dashboard): http://localhost:3000" -ForegroundColor Yellow
...
Write-Host "NOTE: If you see errors above, please check the logs." -ForegroundColor Green
Write-Host ""
